...
<div class="container">
  <div class="row justify-content-center">
    ...
    <div class="col-md-12 form_page">
      <div class="card">
        <div class="card-body">
          <form action="{{route('admin.service_slot.store')}}" class="" method="post">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="date" name="service_date" class="form-control"  value="{{old('service_date')}}" id="service_date" aria-describedby="nameHelp">
